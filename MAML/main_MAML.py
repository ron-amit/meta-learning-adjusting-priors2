...
from Utils.common import save_model_state, load_model_state, create_result_dir, set_random_seed, write_to_log, save_run_data, boolean_string
...
parser.add_argument('--MAML_Use_Test_Data', type=boolean_string, help='If true MAML evaluates loss with batch from test data (instead of drawing from train set)',
                    default=False)
